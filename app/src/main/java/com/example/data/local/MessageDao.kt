...
interface MessageDao {
    ...
    @Query("SELECT * FROM messages WHERE address = :address AND body = :body AND ABS(timestamp - :timestamp) < 5000 LIMIT 1")
    suspend fun findDuplicate(address: String, body: String, timestamp: Long): MessageItem?
