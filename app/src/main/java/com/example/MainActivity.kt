...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            var userBypassedDefaultSmsPrompt by remember { mutableStateOf(false) }
                ...
                Scaffold(
                    ...
                    when (val screen = currentScreen) {
                        is Screen.Conversations -> {
                            if (!uiState.isDefaultSmsApp && !userBypassedDefaultSmsPrompt) {
                                DefaultSmsPromptScreen(
                                    onRequestDefaultSms = { requestDefaultSmsApp() },
                                    onOpenSettings = { currentScreen = Screen.Settings },
                                    onContinueAnyway = { userBypassedDefaultSmsPrompt = true },
                        ...
                        is Screen.Settings -> {
                            SettingsScreen(
                                ...
                                onTestNotification = {
                                    viewModel.testBackgroundNotification()
                                },
